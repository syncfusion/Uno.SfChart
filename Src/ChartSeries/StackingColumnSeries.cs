...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    public partial class StackingColumnSeries : StackingSeriesBase, ISegmentSelectable, ISegmentSpacing
    {
        ...
        {
            return base.CloneSeries(new StackingColumnSeries()
            {
        ...
        {
            var series = d as StackingColumnSeries;
            if (series.Area != null)
